...
def info_expander(map_key, segmented_key):
    with st.expander("Very Important Info (Click here to open)!", icon=":material/info:", expanded=False):
        ...
        with TICKETS_INFO_TAB:
            ...
            st.markdown("* Please make sure that once an order has been confirmed, the payment is made quickly, otherwise, the ticket will be available for other users to buy. You may need to initiate a fresh booking.")
