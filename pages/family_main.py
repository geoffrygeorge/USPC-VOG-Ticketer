...
expander_functions.info_expander("family_map", "family_segment")
    ...
    if st.session_state.get("booking_success_family_gold"):
        ...
        if family_gold_form_submitted:
            if not FIRST_NAME or not LAST_NAME or not MOBILE_NUMBER or not EMAIL:
                ...
                show_family_gold_confirm_dialog(FIRST_NAME.strip().title(), LAST_NAME.strip().title(), "".join(MOBILE_NUMBER.split()), EMAIL.strip(), FORM_CATEGORY, EVENT_ORDER_ID, FORM_TICKET_TYPE, AVAILABLE_TICKET_FILTER_FORMULA)
    ...
    if st.session_state.get("booking_success_family_platinum"):
        ...
        if family_platinum_form_submitted:
            if not FIRST_NAME or not LAST_NAME or not MOBILE_NUMBER or not EMAIL:
                ...
                show_family_platinum_confirm_dialog(FIRST_NAME.strip().title(), LAST_NAME.strip().title(), "".join(MOBILE_NUMBER.split()), EMAIL.strip(), FORM_CATEGORY, EVENT_ORDER_ID, FORM_TICKET_TYPE, AVAILABLE_TICKET_FILTER_FORMULA)
    ...
    if st.session_state.get("booking_success_family_diamond"):
        ...
        if family_diamond_form_submitted:
            if not FIRST_NAME or not LAST_NAME or not MOBILE_NUMBER or not EMAIL:
                ...
                show_family_diamond_confirm_dialog(FIRST_NAME.strip().title(), LAST_NAME.strip().title(), "".join(MOBILE_NUMBER.split()), EMAIL.strip(), FORM_CATEGORY, EVENT_ORDER_ID, FORM_TICKET_TYPE, AVAILABLE_TICKET_FILTER_FORMULA)
