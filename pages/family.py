...
with GOLD_TAB:
    ...
    def show_family_gold_confirm_dialog(first_name, last_name, email, form_category, event_order_id, form_ticket_type, available_ticket_filter_formula):
        ...
        with st_horizontal():
            if st.button("Confirm", type="primary", width="stretch", key="family_gold_confirm_button"):
                try:
                    airtable_functions.airtable_family_ticket_assigner(first_name, last_name, email, form_category, event_order_id, form_ticket_type, available_ticket_filter_formula)
    ...
    if family_gold_form_submitted:
        if not FIRST_NAME or not LAST_NAME or not EMAIL:
            ...
            show_family_gold_confirm_dialog(FIRST_NAME, LAST_NAME, EMAIL, FORM_CATEGORY, EVENT_ORDER_ID, FORM_TICKET_TYPE, AVAILABLE_TICKET_FILTER_FORMULA)
...
with PLATINUM_TAB:
    ...
    @st.dialog("Confirm Booking", width="small")
    def show_family_platinum_confirm_dialog(first_name, last_name, email, form_category, event_order_id, form_ticket_type, available_ticket_filter_formula):
        st.write(f"Are you sure you want to confirm the booking for **{first_name} {last_name}**?")
    ...
    if family_platinum_form_submitted:
        if not FIRST_NAME or not LAST_NAME or not EMAIL:
            ...
            show_family_platinum_confirm_dialog(FIRST_NAME, LAST_NAME, EMAIL, FORM_CATEGORY, EVENT_ORDER_ID, FORM_TICKET_TYPE, AVAILABLE_TICKET_FILTER_FORMULA)
...
with DIAMOND_TAB:
    ...
    @st.dialog("Confirm Booking", width="small")
    def show_family_diamond_confirm_dialog(first_name, last_name, email, form_category, event_order_id, form_ticket_type, available_ticket_filter_formula):
        st.write(f"Are you sure you want to confirm the booking for **{first_name} {last_name}**?")
    ...
    if family_diamond_form_submitted:
        if not FIRST_NAME or not LAST_NAME or not EMAIL:
            ...
            show_family_diamond_confirm_dialog(FIRST_NAME, LAST_NAME, EMAIL, FORM_CATEGORY, EVENT_ORDER_ID, FORM_TICKET_TYPE, AVAILABLE_TICKET_FILTER_FORMULA)
