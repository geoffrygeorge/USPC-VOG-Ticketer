...
with GOLD_TAB:
    ...
    with st.form("family_gold_form"):
        FIRST_NAME = st.text_input("First Name", key="family_gold_first_name")
        LAST_NAME = st.text_input("Last Name", key="family_gold_last_name")
        EMAIL = st.text_input("Email", key="family_gold_email")
...
with PLATINUM_TAB:
    ...
    with st.form("family_platinum_form"):
        FIRST_NAME = st.text_input("First Name", key="family_platinum_first_name")
        LAST_NAME = st.text_input("Last Name", key="family_platinum_last_name")
        EMAIL = st.text_input("Email", key="family_platinum_email")
        form_submitted = st.form_submit_button("Confirm 4 Orders!")
...
with DIAMOND_TAB:
    ...
    with st.form("family_diamond_form"):
        FIRST_NAME = st.text_input("First Name", key="family_diamond_first_name")
        LAST_NAME = st.text_input("Last Name", key="family_diamond_last_name")
        EMAIL = st.text_input("Email", key="family_diamond_email")
        form_submitted = st.form_submit_button("Confirm 4 Orders!")
